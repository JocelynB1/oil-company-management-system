...
<div class="row">
                                {!! Form::open([
                                'method' => 'GET',
                                'action'=>'DisplayRecordsController@displayAccountantSales'
                                ])!!}
                                @csrf
                                ...
                                <a href="{{route('displayrecords.accountantsales')}}">Reset</a>
                            </div>
                            <div>
                                <a href="{{route('displayrecords.accountantsales',['sales_date'=>request('sales_date'),'sort'=>'asc'])}}">Ascending</a>
                                <a href="{{route('displayrecords.accountantsales',['sales_date'=>request('sales_date'),'sort'=>'desc'])}}">Descending</a>
                            </div>
                        </div>
*/
$fieldList=array(
...
window.onload = function () {
    ...
    textQuery= "waiting_for_accountant";
                        ...
                        <table class="table table-striped table-borded table-hover table-sm table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$accountantsale->sales_date}}</td>            
                                    <td>{{$accountantsale->customer_name}}</td>            
                                    <td>{{ $accountantsale->customer_number}}</td>
                                    <td>{{$accountantsale->supplier_name}}</td>   
                                    <td>
                                        <a href="{{ route('accountantsales.edit', $accountantsale->id) }}"  class="btn btn-primary">Complete Sale</a>
                                    </td>
