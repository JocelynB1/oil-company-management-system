...
<div class="container">
    ...
    <div class="row">
            <div class="col-auto">
                ...
                'method' => 'GET',
                'class'=>"form-inline",                              
                'action'=>'DisplayRecordsController@displayEmployees'
                ])!!}
                @csrf
                ...
                <a href="{{route('displayrecords.employees')}}">Reset</a>
            </div>
        
        <div class="col-auto text-right">
        <a href="{{route('displayrecords.employees',['bank_name'=>request('bank_name'),'sort'=>'asc'])}}">Ascending</a>
        <a href="{{route('displayrecords.employees',['bank_name'=>request('bank_name'),'sort'=>'desc'])}}">Descending</a>
        </div>
    </div>
    <div class="row">   
        <div class="form-row align-items-center">            
            ...
            'method' => 'GET',
            'class'=>"form-inline",
            'action'=>'ExcelController@exportEmployees'
            ])!!}
            @csrf
            <div class="col-auto">            
...
<thead>
    ...
    <tbody>
        ...
        <tr>
                <td>  {!! Form::open([
                        'method' => 'DELETE',
                        'action' => ['WorkerController@destroy', $employee->id]
                    ]) !!}
                        {!! Form::submit('Delete', ['class' => 'btn btn-danger']) !!}
                    {!! Form::close() !!}
                </td>
    
        <td><a href="{{ action('WorkerController@edit', $employee->id) }}" style="color: black">{{$employee->id}}</a></td>
        <td><a href="{{ action('WorkerController@edit', $employee->id) }}" style="color: black">{{$employee->type}}</a></td>
        <td><a href="{{ action('WorkerController@edit', $employee->id) }}" style="color: black">{{$employee->employee_name}}</a></td>
        <td><a href="{{ action('WorkerController@edit', $employee->id) }}" style="color: black">{{$employee->phone_number}}</a></td>
        <td><a href="{{ action('WorkerController@edit', $employee->id) }}" style="color: black">{{$employee->created_by}}</a></td>  
        <td><a href="{{ action('WorkerController@edit', $employee->id) }}" style="color: black">{{$employee->modified_by}}</a></td>  
        <td><a href="{{ action('WorkerController@edit', $employee->id) }}" style="color: black">{{$employee->created_at}}</a></td>
        <td><a href="{{ action('WorkerController@edit', $employee->id) }}" style="color: black">{{$employee->updated_at}}</a></td>
        </tr>
        @endforeach
    </tbody>
</thead>
