...
{!!Form::label('transaction_type','Transacation Type:',['class'=>'col-md-4 col-form-label text-md-right']) !!}
<div class="col-md-6">
{!!Form::select('transaction_type', [null=>'Please Select','Debt Opening Balance'=>'Debt Opening Balance',"Payment Advance"=>'Payment Advance',], [null=>'Please Select'], ['class' => 'form-control'])!!}
</div>
</div>
